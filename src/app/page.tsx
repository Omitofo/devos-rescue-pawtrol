  ...
  return (
    <>
      <section className="relative -mt-14 overflow-hidden border-b border-border bg-[#FFF8F0] sm:-mt-16">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-8 px-4 pb-10 pt-20 sm:min-h-[32rem] sm:px-6 sm:pb-16 sm:pt-14 lg:min-h-[36rem] lg:grid-cols-2 lg:gap-12 lg:pb-20 lg:pt-14">
